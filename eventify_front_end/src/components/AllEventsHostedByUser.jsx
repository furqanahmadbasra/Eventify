...
// import UpdateEventModal from './UpdateEventModal'; // import modaln
// import { useNavigate } from 'react-router-dom';
// import ParticleBackground from './ParticleBackground'; // Import your ParticleBackground component
...
//         setEventToEdit(event); // pass full event
//         setIsModalOpen(true);
//     };
...
//                                     <button onClick={() => handleUpdate(event)} className="btn-update">Update</button>
//                                 </div>
//                                 <button onClick={() => handleSEEREGISTERED_USERS(event._id)} className="btn-primary">
